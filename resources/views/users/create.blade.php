...
<div class="w-full relative mt-2 my-24 overflow-hidden p-2 bg-white">
    ...
    <div class="grid grid-cols-12 bg-white">
        ...
        <div class="col-span-12 px-3 text-center py-6 flex space-x-2 border-b border-solid md:space-x-0 md:space-y-4 md:flex-col md:col-span-2 md:justify-start overflow-x-scroll scrollber-container custom-scrollbar" style="display: none">
                ...
                <div class="shadow overflow-hidden sm:rounded-md p-2 bg-white">
                    ...
                    <div class="grid md:grid-cols-3 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="hidden px-4 py-2 bg-white sm:p-2">
                            ...
                            <label for="last_name" class="block uppercase tracking-wide text-gray-700 text-xs font-bold">Last Name</label>
                            <input type="text" name="last_name" id="last_name" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full" autofocus
                                value="{{ old('last_name') }}" />
                            @error('last_name')
                        ...
                        <div class="hidden px-4 py-2 bg-white sm:p-2">
                            <label for="first_name" class="block uppercase tracking-wide text-gray-700 text-xs font-bold">First Name</label>
                    ...
                    <div class="grid md:grid-cols-3 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2 col-span-1">
                            ...
                            <input type="text" name="mobile_number" id="mobile_number" maxlength='11' class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full"
                                value="{{ old('mobile_number') }}" autocomplete="off" data-mask="00000000000" required/>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <option value="" @if (""==old('account_type')) selected @endif>Admin</option>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            @if (Auth::user()->user_type<>"2")
                                <option value="1" @if ("1"==old('user_type')) selected @endif>System Administrator</option>
                            @endif
                            <option value="2" @if ("2"==old('user_type')) selected @endif>User Administrator</option>
                            <option value="3" @if ("3"==old('user_type')) selected @endif>Level 1 Accreditor</option>
                            <option value="4" @if ("4"==old('user_type')) selected @endif>Level 2 Accreditor</option>
                            <option value="6" @if ("6"==old('user_type')) selected @endif>Surveyor</option>
                            <option value="5" @if ("5"==old('user_type')) selected @endif>Client</option>
                            </select>
                            @error('user_type')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
