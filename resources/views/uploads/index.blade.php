                  ...
                  <tr>
                    <div class="mt-3 space-y-3 rounded-lg bg-white p-4 shadow">
                      <div class="flex items-center space-x-2 text-sm">
                        <div class="font-bold uppercase text-gray-900">DATE SUBMITTED:</div>
                        <div class="text-gray-900"> {{ date('m/d/Y', strtotime($upload->created_at)) }}</div>
                      </div>
                      <div class="flex items-center space-x-2 text-sm">
                        <div class="font-bold uppercase text-blue-300">Client Name:</div>
                        <div class="text-gray-900"> {{ $upload->user->client_name }}</div>
                      </div>
                      <div class="flex items-center text-sm">
                        <div class="mr-5 font-bold uppercase text-teal-600">Photo:</div>
                        <img src="{{ $upload->url }}" class="w-16 md:w-32 lg:w-48">
                      </div>
                    </div>
                  </tr>
