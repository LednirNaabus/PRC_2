                ...
                <div class="shadow overflow-hidden sm:rounded-md p-2 bg-white">
                    ...
                    <div class="grid md:grid-cols-1 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <option value="1" @if ("1"==old('account_type', $question->account_type)) selected @endif>School</option>
                            <option value="2" @if ("2"==old('account_type', $question->account_type)) selected @endif>Hospital</option>
                            </select>
                            @error('account_type')
                    ...
                    <div class="grid md:grid-cols-1 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2 col-span-2">
                            <label for="category" class="block uppercase tracking-wide text-gray-700 text-xs font-bold">Category</label>
                    ...
                    <div class="grid md:grid-cols-1 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2 col-span-2">
                            ...
                            <input type="text" name="group_category" id="group_category" maxlength="100" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full" 
                                value="{{ old('group_category', $question->group_category) }}" />
                    ...
                    <div class="grid md:grid-cols-1 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2 col-span-2">
                            ...
                            <textarea name="question" rows="5" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" required>{{ old('question', $question->question) }}</textarea>
                            @error('question')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid md:grid-cols-1 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2 col-span-2">
                            ...
                            <option value="1" @if ("1"==old('required', $question->required)) selected @endif>Yes</option>
                            <option value="0" @if ("0"==old('required', $question->required)) selected @endif>No</option>
                            </select>
                            @error('required')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid md:grid-cols-4 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="text" name="option_1" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('option_1', $question->option_1) }}">
                            @error('option_1')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="text" name="option_2" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('option_2', $question->option_2) }}">
                            @error('option_2')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="text" name="option_3" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('option_3', $question->option_3) }}">
                            @error('option_3')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="text" name="option_4" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('option_4', $question->option_4) }}">
                            @error('option_4')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid md:grid-cols-4 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="text" name="option_5" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('option_5', $question->option_5) }}">
                            @error('option_5')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="text" name="option_6" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('option_6', $question->option_6) }}">
                            @error('option_6')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="text" name="option_7" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('option_7', $question->option_7) }}">
                            @error('option_7')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="text" name="option_8" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('option_8', $question->option_8) }}">
                            @error('option_8')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="hidden grid md:grid-cols-4 sm:grid-cols-12 text-white text-sm leading-6">
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="number" name="score_1" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('score_1', $question->score_1) }}">
                            @error('score_1')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="number" name="score_2" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('score_2', $question->score_2) }}">
                            @error('score_2')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="number" name="score_3" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('score_3', $question->score_3) }}">
                            @error('score_3')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-2 bg-white sm:p-2">
                            ...
                            <input type="number" name="score_4" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full p-2" value="{{ old('score_4', $question->score_4) }}">
                            @error('score_4')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
