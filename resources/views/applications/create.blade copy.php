        ...
        for (i=1;i<=count;i++)
            {   
                if (document.getElementById('answer_'+i).value !='') {
                    ...
                    document.getElementById('urlValue_'+i).innerHTML = document.getElementById('url_'+i).value;
                }
            }
                            ...
                            @if (count($questions) > 0) 
                                ...
                                @foreach($questions as $key => $question)
                                    ...
                                    @if ($category<>$question->category)
                                        <tr>
                                            <td style="font-weight: bold" colspan="5"><br><br>{{ $question->category }}</td>
                                        </tr>
                                    @endif

                                    @php $category = $question->category @endphp
                                            ...
                                            <div class="grid md:grid-cols-1 sm:grid-cols-12 text-gray text-sm leading-6">
                                                ...
                                                <div class="px-4 py-2 bg-white sm:p-2">
                                                    @if ($question->required=='1')
                                                        <small class="animated flash text-danger" style="font-size: 10px; padding: 1px;">Required</small></label>
                                                    @endif
                                                    <textarea rows="5" cols="40" id="answer_{{ $i }}" name="answer_{{ $i }}" class="form-input rounded-md shadow-sm mt-1 block text-gray-900 w-full" @if ($question->required=='1') required @endif></textarea>
                                                </div>
                                ...
                                <div class="p-6">
                                    ...
                                    @foreach($questions as $key => $question)
                                        ...
                                        <div class="p-2 text-sm" id="{{ "answerSummary_".$i }}" style="display:none">
                                            ...
                                            <br><b>Image:</b><br>
                                            <span class="text-sm" id="{{ "urlValue_".$i }}"></span><br><br>
                                        </div>
