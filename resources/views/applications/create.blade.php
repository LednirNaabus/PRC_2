...
<script>
    function toggle() {
        ...
        for (i=1;i<=count;i++)
            {   
                if (document.getElementById('answer_'+i).value !='' || document.getElementById('url_'+i).value !='') {
                    ...
                    document.getElementById('hrefValue_'+i).href = document.getElementById('url_'+i).value;
                ...
                <form method="POST" action="{{ route('applications.store') }}" enctype="multipart/form-data">
                                            ...
                                            <td colspan="4">
                                                ...
                                                <div class="grid md:grid-cols-1 sm:grid-cols-12 text-gray text-sm leading-6">
                                                    ...
                                                    <div class="px-4 py-2 bg-white sm:p-2">
                                                        ...
                                                        <input type="file" name="url_{{ $i }}" class="form-control" @if ($question->required=='1') required @endif>
                    ...
                    <div class="row mb-0">
                        <div class="col-md-12" style="text-align: right">
                            <button class="btn btn-lg btn-block btn-primary text-right bg-blue-500">
                                {{ __('Submit') }}
                            </button>
                        </div>
                    </div>
                                ...
                                <div class="p-6">
                                    ...
                                    @foreach($questions as $key => $question)
                                        ...
                                        <div class="p-2 text-sm" id="{{ "answerSummary_".$i }}" style="display:none">
                                            ...
                                            <a href="" id="{{ "hrefValue_".$i }}" class="underline" target="_blank">Click here to Preview File</a><br><br>
                                            <img id="{{ "urlValue_".$i }}" class="hidden w-16 md:w-32 lg:w-48"><br><br>
                                        </div>
