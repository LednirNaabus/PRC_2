                ...
                <div class="px-4 pt-4">
                    ...
                    <div class="accordion-item bg-white border border-gray-200">
                        <h2 class="accordion-header mb-0" id="heading{{ $start }}">
                            <button class="accordion-button relative flex items-center w-full py-4 pl-5 px-sm-5 text-sm sm:text-base text-gray-800 text-left bg-white border-0 rounded-none transition focus:outline-none" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $start }}" aria-expanded="true" aria-controls="collapse{{ $start }}">
                        ...
                        <div id="collapse{{ $start }}" class="accordion-collapse collapse @if ($start==1) show @endif" aria-labelledby="heading{{ $start }}" data-bs-parent="#accordionExample">
                            <div class="accordion-body px-1 px-sm-5">
